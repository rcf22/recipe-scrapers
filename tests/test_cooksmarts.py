from recipe_scrapers.cooksmarts import CookSmarts
from tests import ScraperTest


class TestCookSmartsScraper(ScraperTest):

    scraper_class = CookSmarts

    def test_host(self):
        self.assertEqual("cooksmarts.com", self.harvester_class.host())
    ...
    # def test_image(self):
        # self.assertEqual(
            # "https://sharkninja-cooksmarts.s3.eu-west-1.amazonaws.com/wp-content/uploads/2022/02/23144350/Vegan-Lemon-Cupcakes-2220x1000.jpg",
